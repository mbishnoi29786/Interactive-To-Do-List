...
import { createElement, createTextInput } from "../../shared/element-utils.js";
import { setupModalClose, trapFocus } from "../../shared/dialog-utils.js";
...
function createSearchModalHeader(USER) {
    ...
    const searchIcon = createElement('img', 'search-icon', '', { 'src': '../../assets/images/search-icon.png', 'alt' : 'search-icon' });
